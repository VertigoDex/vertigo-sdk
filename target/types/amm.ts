  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "mint_a",
          docs: ["The token mint of the tokens used in the pool."],
        },
        {
          name: "vault_a",
          writable: true,
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "token_wallet_b",
          docs: ["Token wallet that funds the pool with token B."],
          writable: true,
        },
        {
          name: "pool",
    ...
    {
      name: "quote_buy",
      discriminator: [83, 9, 231, 110, 146, 31, 40, 12],
      accounts: [
        {
          name: "pool",
          pda: {
    ...
    {
      name: "quote_sell",
      discriminator: [5, 178, 49, 206, 140, 231, 131, 145],
      accounts: [
        {
          name: "pool",
          pda: {
