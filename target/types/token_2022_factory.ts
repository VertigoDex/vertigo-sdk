...
export const IDL: Token2022Factory = {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const",
                value: [102, 97, 99, 116, 111, 114, 121],
              },
              {
                kind: "account",
                path: "owner",
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "amm",
          docs: ["The Vertigo program."],
          address: "vrTGoBuy5rYSxAfV3jaRJWHH6nN9WK4NRExGxsk1bCJ",
        },
        {
          name: "factory",
          docs: ["The factory state account."],
          pda: {
            seeds: [
              {
                kind: "const",
        ...
        },
        {
          ...
          docs: ["The authority allowed to mint tokens from `mint`."],
          writable: true,
          signer: true,
        },
        {
        ...
        {
          name: "token_wallet_b",
          docs: ["Token wallet where the initial token reserves come from"],
          writable: true,
          pda: {
            seeds: [
              {
  ...
  accounts: [
    {
      name: "Factory",
      discriminator: [159, 68, 192, 61, 48, 249, 216, 202],
      type: {
        kind: "struct",
        fields: [
          {
