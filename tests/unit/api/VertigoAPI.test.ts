...
describe('VertigoAPI', () => {
  ...
  describe('getPoolStats', () => {
    it('should fetch pool statistics', async () => {
      ...
      expect(fetchMock).toHaveBeenCalledWith(
        expect.stringContaining(`/pools/${MOCK_POOLS.SOL_USDC.toBase58()}/stats`),
        expect.any(Object)
      );
    });
  ...
  describe('getSwapQuote', () => {
    ...
    it('should include user address when provided', async () => {
      const userAddress = new PublicKey('Cv7YDGM6g8fP3LdZDpnQmF9F4XoWfDBwMcj9HrT27kKj');
